...
# avoiding external dependencies like viridis. This way we get clear, interpretable geographic insights.
...
# These spatial plots are highly relevant to our social problem because they highlight geographic disparities in both financial difficulty and psychological distress across Amsterdam. By mapping the average percentages at the neighborhood level, we can identify spatial patterns of vulnerability, where high financial stress coincides with elevated mental health complaints. This visual approach allows policymakers and stakeholders to target specific areas for intervention more effectively, such that resources are allocated to neighborhoods with the greatest need.

#The maps also reinforce the correlation between socioeconomic status and mental well-being, which suggests that financial hardship may be linked to higher psychological complaints. This aligns with broader literature on social determinants of health and provides a localized, more data-driven basis for further analysis or action.
```
...
##Finally, the scatterplot confirms the strong correlation between financial and psychological strains, following the linear regression line. This supports the idea that economic hardship is closely linked to mental health problems.
